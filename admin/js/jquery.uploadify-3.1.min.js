    ...
    if (ah.win && ah.ie) {
      ...
      if (e) {
        ...
        if (a) {
          ...
          for (var c = 0; c < f; c++) {
            if (
              !(a[c].nodeType == 1 && a[c].nodeName == "PARAM") &&
              !(a[c].nodeType == 8)
            ) {
    ...
    init: function (d, e) {
      return this.each(function () {
        ...
        if (h) {
          ...
          f.html(
            '<span class="uploadify-button-text">' + j.buttonText + "</span>"
          ).css({
            height: j.height + "px",
  ...
  var a = {
    ...
    onUploadError: function (e, i, h) {
      ...
      switch (i) {
        ...
        case SWFUpload.UPLOAD_ERROR.FILE_CANCELLED:
          ...
          if (
            e.status == SWFUpload.FILE_STATUS.IN_PROGRESS ||
      ...
      if (c.inArray("onUploadError", f.overrideEvents) < 0) {
        if (
          i != SWFUpload.UPLOAD_ERROR.FILE_CANCELLED &&
        ...
        c("#" + e.id)
          ...
          .css("width", "1px");
        if (
          i != SWFUpload.UPLOAD_ERROR.SPECIFIED_FILE_ID_NOT_FOUND &&
    ...
    onUploadProgress: function (g, m, j) {
      ...
      if (this.queueData.averageSpeed > 0) {
        this.queueData.averageSpeed = Math.floor(
          (this.queueData.averageSpeed + f) / 2
        );
      } else {
      ...
      if (c.inArray("onUploadProgress", h.overrideEvents) < 0) {
        if (h.progressData == "percentage") {
          ...
          if (h.progressData == "speed" && k > 500) {
            c("#" + g.id)
              .find(".data")
              .html(" - " + this.queueData.averageSpeed + o);
          }
        }
        c("#" + g.id)
          .find(".uploadify-progress-bar")
          ...
          success: function (h) {
            if (h == 1) {
              ...
              if (!g) {
                ...
                c("#" + d.id).remove();
                if (
                  this.queueData.uploadQueue.length > 0 &&
