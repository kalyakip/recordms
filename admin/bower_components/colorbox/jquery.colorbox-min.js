(function (e, t, i) {
  ...
  var w,
    ...
    ct = (function () {
      ...
      return function () {
        r
          ? B.slideshow || (lt.unbind(nt, n), n())
          : B.slideshow &&
            k[1] &&
            ((r = !0), lt.one(nt, n), B.slideshowAuto ? i() : o(), M.show());
      };
    })();
  e.colorbox ||
    (e(f),
    ...
    (Q.position = function (t, i) {
      ...
      if (
        ...
        (s = E.scrollLeft()),
        B.fixed
          ? ((c.top -= l), (c.left -= s), g.css({ position: "fixed" }))
          : ((a = l), (d = s), g.css({ position: "absolute" })),
        (d +=
          B.right !== !1
